...
var TableComponent = (function () {
    ...
    Object.defineProperty(TableComponent.prototype, "categories", {
        get: function () {
            return this.model.getProducts().map(function (p) { return p.category; }).filter(function (category, index, array) { return array.indexOf(category) == index; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    TableComponent = __decorate([
        core_1.Component({ selector: "paTable", moduleId: module.id, templateUrl: "table.component.html" }), 
